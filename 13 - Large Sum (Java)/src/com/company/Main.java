...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 49; i >= 0; i--){
            System.out.println("Now attempting the " + i + "th digit.");
            for(int j = 0; j < 100; j++){
                temp += numArray[j][i];
            }
            ansVec.insertElementAt((temp % 10), 0);
            System.out.println("The sum of that column is: " + temp);
            temp = temp / 10;
            System.out.println("The starting sum of the next column is: " + temp);
        }
        ansVec.insertElementAt(temp, 0);
        System.out.println("The first 10 digits are:");
        for(int i = 0; i < 10; i++){
